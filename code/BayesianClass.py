...
for j in range(len(values)):
    river_sample.append(data[values[j][1]][values[j][0]])
...
priorLand = 0.3 #float(priorLand)
priorRiver = 0.7 #float(priorRiver)
...
fig, ax = plt.subplots()
fig.suptitle('Bayes with prior probability of river 0.7')
